      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <Link href="/" className="text-sm hover:text-white transition-colors">Trang Chủ</Link>
            <Link href="/luoc-su-hoi-thanh" className="text-sm hover:text-white transition-colors">Lược Sử Hội Thánh</Link>
            <Link href="/category/thong-bao" className="text-sm hover:text-white transition-colors">Thông Báo</Link>
            <Link href="/category/tin-tuc" className="text-sm hover:text-white transition-colors">Tin Tức</Link>
            <Link href="/category/bai-hoc" className="text-sm hover:text-white transition-colors">Bài Học</Link>
            <Link href="/dang-hien" className="text-sm hover:text-white transition-colors">Dâng Hiến</Link>
          </div>
        </div>
